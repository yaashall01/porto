                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-6 col-md-6">
                            <div className="experience-list">
                                {
                                    workExperience.map(({ id, institute, position, years ,logo}) => <Card key={id} institute={institute} position={position} years={years} logo={logo}/>)
                                }
                            </div>
                        </div>
...
const Card = ({ institute, position, years, logo }) => {
    return (
        <SlideUp>
