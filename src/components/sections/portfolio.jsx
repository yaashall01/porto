        ...
        <section id="portfolio" className="projects-area">
            <div className="container">
                ...
                <div className="row project-masonry-active">
                    {filteredProjects.map(({category, id, src, title, description, tools})=><Card key={id} category={category} title={title} src={src} animationClass={animationClass} openLightbox={openLightbox} tools={tools} description={description}/>)}
                </div>
            </div>
...
const Card = ({category, title, src, description, tools, animationClass, openLightbox}) => {
    return (
